...
# Before publishing: move to _posts/ as YYYY-MM-DD-how-are-models-used-in-health-economics.md
# (date comes from the filename; permalink resolves from _config.yml to /how-are-models-used-in-health-economics/)
---
